#> pk_shulker_boxes_names:blocks/shulker_box/name/remove/blocks_list/remove_recursive
...
execute if data storage pk.common:data Temp.Array.Search[{}] run function pk_shulker_boxes_names:blocks/shulker_box/name/remove/blocks_list/remove_recursive