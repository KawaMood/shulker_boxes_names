#> pk_shulker_boxes_names:base/uninstall/cb_3
...
execute summon marker run function pk_shulker_boxes_names:base/uninstall/marker_initialize

# Start process in the current chunk
function pk_shulker_boxes_names:base/uninstall/chunk_check_state_recursive